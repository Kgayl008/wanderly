        ...
        <div className='home'>
            <div className='home__header'>
                ...
                <h2 className='home__text'>
                    Swipe Right on Your Next Adventure with Wanderly - The Travel App for Solo Explorers
                </h2>
            </div>
            <h2 className='home__sub-title'>Find Your
                <br/>Next Adventure
            </h2>
            <div className='card__container'>
                <div className='card__mobile-container'>
                    <div className='row__one'>
                        ...
                        <div className='card__wrapper'>
                            <img src={Greece}
                                alt='View of the city in Santorini, Greece'
                                className='card__visuals'/>
                            <div className='card__text'>
